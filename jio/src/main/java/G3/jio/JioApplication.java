    ...
    public static void main(String[] args) {
        ...
        System.out.println("[Add Student]: "
                + studentRepository.save(
                        new Student("admin", "admin@admin.com", encoder.encode("admin"), "12345678", "87654321",
                                LocalDate.of(2023, 1, 2), Role.ADMIN))
                        .getUsername());
        EventRepository eventRepo = ctx.getBean(EventRepository.class);

        eventRepo.save(new Event(null, ".Hack Social Night", LocalDate.of(2023, 2, 10), LocalDate.of(2023, 2, 10),
                "SCIS1 B1 Alcove", "/socialnight.jpg", 55, 0,
                ...
                true, null));
        eventRepo.save(new Event(null, "Ellipsis Back2Sku Welfare Drive", LocalDate.of(2023, 8, 16),
                LocalDate.of(2023, 8, 16), "SCIS1 Basement (near Big Steps)", "/back2skuwelfaredrive.jpg", 150, 0,
                ...
                true, null));
        eventRepo.save(new Event(null, ".Hack WAD2 Workshop 2023", LocalDate.of(2023, 10, 20),
                LocalDate.of(2023, 10, 20), "SCIS1 Seminar Room B1-1", "/wad2workshop.jpg", 80, 0,
                ...
                true, null));
        eventRepo.save(new Event(null, ".Hack Certification Programme (DHCP)", LocalDate.of(2023, 3, 17),
                LocalDate.of(2023, 3, 17), "SCIS2 Computing Lab B1-1", "/dhcpworkshop.jpg", 90, 0,
